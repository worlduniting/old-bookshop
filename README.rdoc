...
For an explanation of the example, please see this article. - http://www.alistapart.com/articles/boom BookShop uses the boom microformat - http://microformats.org/wiki/book-brainstorming
